...
EVENT_BLUEPRINTS = [
    ...
    },
    {
        ...
        "program": [
            ("Въведение и настройка на средата", "Преслав Иванов", 0, 1),
            ("Модели и миграции", "Преслав Иванов", 1, 3),
            ("Изгледи, шаблони и форми", "Преслав Иванов", 3, 5),
...
class Command(BaseCommand):
    ...
    def _create_users(self) -> dict:
        ...
        organizers = []
        organizer_data = [
            ("organizer1", "Преслав", "Иванов", "ПГКНМА „Проф. Минко Балкански“"),
    ...
    def _print_summary(self, users) -> None:
        ...
        self.stdout.write("  organizer1  — Организатор (Преслав Иванов)")
